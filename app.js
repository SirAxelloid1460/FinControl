...
async function delEntry(id){if(!confirm("¿Eliminar este registro?"))return;entries=entries.filter(e=>String(e.id)!==String(id));retagHistory();render();await push();}
